...
class MyMainTabBarController: UITabBarController {
    let photoCollectionNavigationController = PhotoCollectionViewController(nibName: nil, bundle: nil)
    let favouritePhotoNavigationController = FavouritePhotoViewController(nibName: nil, bundle: nil)
